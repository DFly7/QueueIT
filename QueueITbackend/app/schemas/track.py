...
class TrackOut(BaseModel):
    id: Annotated[str, Field(..., alias="spotify_id", serialization_alias="id", description="Spotify track ID")]
    ...
    class Config:
        ...
        populate_by_name = True # Allow using field name or database column name for input
...
class AddSongRequest(BaseModel):
    # Accept iOS field names in JSON, but allow validation of internal database field names too
